...
#          is_variations_exist=CartItem.objects.filter(product=product,user=current_user).exists() 
#          if is_variations_exist:
#           cart_item=CartItem.objects.filter(product=product, user=current_user)
#           ex_variation_list=[]
#           id=[]
#           for item in cart_item:
...
#         is_variations_exist=CartItem.objects.filter(product=product,cart=cart).exists() 
#         if is_variations_exist:
#             cart_item=CartItem.objects.filter(product=product, cart=cart)
#             ex_variation_list=[]
#             id=[]
